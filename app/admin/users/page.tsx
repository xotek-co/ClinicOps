...
export default function AdminUsersPage() {
  ...
  const { data: result, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await fetch(buildUrl("/api/users"), { credentials: "include" })
      if (!res.ok) {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setCreateOpen(false)
      setForm({ name: "", email: "", password: "", role: "STAFF", clinic_location_id: "" })
    },
  })
    ...
    <div className="space-y-8 p-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Select value={statusFilter} onValueChange={(v) => setFilter("is_active", v)}>
                ...
                <Table>
                  ...
                  <TableBody>
                    {users.length === 0 ? (
                      ...
                      users.map((u: { id: string; name: string; email: string; role: string; clinic_location_id: string | null; clinic_location?: { name?: string }; is_active: boolean }) => (
                        <TableRow key={u.id}>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select
                ...
                onValueChange={(v) => setForm((f) => ({ ...f, clinic_location_id: v }))}
              >
                <SelectTrigger>
